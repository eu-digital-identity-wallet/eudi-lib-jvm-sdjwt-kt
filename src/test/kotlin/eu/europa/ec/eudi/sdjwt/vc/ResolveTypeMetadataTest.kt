...
class ResolveTypeMetadataTest {
    ...
    @Test
    fun `Resolve succeed when child and parent has the same mandatory value`() =
        runTest {
            val parent =
                SdJwtVcTypeMetadata(
                    vct = parentVct,
    ...
    @Test
    fun `Resolve succeed when child has mandatory field but parent doesn't`() =
        runTest {
            val parent =
                SdJwtVcTypeMetadata(
                    vct = parentVct,
    ...
    @Test
    fun `Resolve fails when child overrides mandatory field of parent`() =
        runTest {
            val parent =
                SdJwtVcTypeMetadata(
                    vct = parentVct,
    ...
    @Test
    fun `Resolve succeed when child has Sd Always as parent`() =
        runTest {
            val parent =
                SdJwtVcTypeMetadata(
                    vct = parentVct,
    ...
    @Test
    fun `Resolve succeed when child has Sd Always and parent has Allowed`() =
        runTest {
            val parent =
                SdJwtVcTypeMetadata(
                    vct = parentVct,
    ...
    @Test
    fun `Resolve succeed when child has Sd Always and parent doesn't specify`() =
        runTest {
            val parent =
                SdJwtVcTypeMetadata(
                    vct = parentVct,
    ...
    @Test
    fun `Resolve fails when child overrides Sd Always of parent`() =
        runTest {
            val parent =
                SdJwtVcTypeMetadata(
                    vct = parentVct,
    ...
    @Test
    fun `Resolve fails when child overrides Sd never of parent`() =
        runTest {
            val parent =
                SdJwtVcTypeMetadata(
                    vct = parentVct,
    ...
    @Test
    fun `resolution fails when parent lookup limit is exceeded`() =
        runTest {
            val grandfather =
                SdJwtVcTypeMetadata(
                    vct = grandfatherVct,
