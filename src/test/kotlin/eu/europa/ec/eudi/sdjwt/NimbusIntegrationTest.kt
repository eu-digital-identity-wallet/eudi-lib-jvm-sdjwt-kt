...
private fun createContext(algorithm: JWSAlgorithm): Context =
    with(NimbusSdJwtOps) {
        ...
        when (algorithm) {
            ...
            in JWSAlgorithm.Family.HMAC_SHA -> {
                ...
                throw IllegalArgumentException("Unknown JWSAlgorithm $algorithm")
            }
        }
    }
